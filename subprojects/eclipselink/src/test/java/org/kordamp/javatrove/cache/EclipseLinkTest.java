 ...
 */
public class EclipseLinkTest extends AbstractCacheTestCase {
    @Override
    protected Class<? extends Person> resolvePersonClass() {
        return EclipseLinkPerson.class;
    }
    ...
    protected TypedQuery<? extends Person> createQuery(EntityManager entityManager) {
        return entityManager.createQuery("select p from EclipseLinkPerson p", Person.class);
    }
