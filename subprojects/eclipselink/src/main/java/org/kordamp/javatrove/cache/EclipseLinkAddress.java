...
public class EclipseLinkAddress implements Address {
    private static final long serialVersionUID = 5361983569995579278L;
    ...
    @ManyToOne(targetEntity = EclipseLinkPerson.class)
    @JoinColumn(name = "person_id")
    private Person person;

    public EclipseLinkAddress() {
    }

    public EclipseLinkAddress(String address) {
        setAddress(address);
    }
