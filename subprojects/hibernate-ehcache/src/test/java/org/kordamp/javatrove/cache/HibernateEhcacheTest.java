 ...
 */
public class HibernateEhcacheTest extends AbstractCacheTestCase {
    @Override
    ...
    protected Object createPerson(int index) {
        ...
        return new HbmPerson("name_" + suffix,
            "lastname_" + suffix,
            asList(new HbmAddress("home_address_" + suffix + "_001"), new HbmAddress("office_address_" + suffix + "002")));
    }
